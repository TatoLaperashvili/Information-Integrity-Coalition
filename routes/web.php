...
Route::middleware(['auth.check'])->group(function () {
    ...
    */
       ...
       Route::delete('/admin/section/posts/DeleteImage/{que}', [PostController::class, 'DeleteImage']);
        ...
        Route::get('/admin/contactsubmission/{submission}', [SubmissionController::class, 'contactshow']);
  		Route::get('/admin/updatesubmission', [SubmissionController::class, 'update']);
 			 Route::get('/admin/updatepostsubmission', [SubmissionController::class, 'updateposts']);
        Route::get('/admin/updateshow/{submission}', [SubmissionController::class, 'updateshow']);
        ...
        Route::delete('/banners/{id}/delete-image', [BannerController::class, 'deleteImage']);
  		...
  		Route::get('/admin/submission/updatexport/{id}', [SubmissionController::class, 'updatexport'] );
  		Route::get('/admin/submission/updatepostsexport/{id}', [SubmissionController::class, 'updatepostsexport'] );
...
Route::post('/updatesubmission', [NotificationController::class, 'updatesubmission'])->name('updatesubmission');
Route::post('/contactsubmission', [NotificationController::class, 'contactsubmission'])->name('contactsubmission');
