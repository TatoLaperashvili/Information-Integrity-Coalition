...
<div class="row">
    <div class="col-12">
        <div class="card-box">
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        ...
                        <tr>
                            ...
                            <th>{{ trans('admin.Registration_Form_Comment') }}</th> 
                        ...
                        <tbody>
                            @foreach ($submissions as $key => $submission)
                                ...
                                <tr {{ $submission->seen == 0 ? 'style=background-color:#d3d3d35e' : ''  }}>
                                    ...
                                    <td><a href="/{{ app()->getLocale() }}/admin/updateshow/{{ $submission->id }}" type="button" class="btn btn-info waves-effect width-md waves-light">{{ trans('admin.more') }}</a></td>
			...
			@if(isset($submission))
            <a class="btn btn-warning" href="/{{ app()->getLocale() }}/admin/submission/updatexport/{{$submission->id }}">Export Submission Data</a>
			@endif
        </div>
    </div>
</div>
