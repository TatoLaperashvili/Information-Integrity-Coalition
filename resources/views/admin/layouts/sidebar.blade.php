...
{{--             
                ...
                <li>
                    <a  href="/{{ app()->getLocale() }}/admin/contactsubmission">
                       
                        <i class="mdi  noti-icon  {{ count($contact_notifications) > 0 ? 'mdi-email pos-rel' : 'mdi-email-open'  }} ">
                            @if (count($contact_notifications) > 0 )
                        
                              <span class=" badge badge-danger rounded-circle noti-icon-badge sidebar-badge">{{ count($contact_notifications) }}</span>
                           
                     
                            @endif
                        </i>
                        <span > {{ trans('admin.contact_submissions') }} </span>
                    </a>
                </li>
                <li>
                    <a  href="/{{ app()->getLocale() }}/admin/updatesubmission">
                        <i class="mdi  noti-icon {{ count($update_notifications) > 0 ? 'mdi-email pos-rel' : 'mdi-email-open'  }} ">
                            @if (count($update_notifications) > 0 )
                           
                            <span class="badge badge-danger rounded-circle noti-icon-badge sidebar-badge">{{ count($update_notifications) }}</span>
                          
                            @endif
                        </i>
                        <span > {{ trans('admin.update_submission') }} </span>
                    </a>
                </li>
                @endif
...
{{-- 
                ...
                <li class="menu-title">{{trans('admin.MADE_BY_IDEA')}}</li> 
            </ul>
