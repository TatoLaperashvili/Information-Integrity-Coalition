<div class="form-group">
    ...
    <div class="col-md-8 dimage d-flex">
    ...
    <span class="deleteimage" data-lang="{{ $locale }}" data-id="{{ $post->id }}" data-token="{{ csrf_token() }}"
        data-route="/{{ app()->getLocale() }}/admin/section/posts/DeleteImage/{{ $post->id }}"
