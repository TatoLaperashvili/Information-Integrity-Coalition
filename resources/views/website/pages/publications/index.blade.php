...
<section>
    <div class="about-banner">
        <img src="{{ image($model->translate(app()->getlocale())->locale_additional['cover'] )}}" alt="{{$model->translate(app()->getlocale())->locale_additional['alt_text']}}" title="{{$model->translate(app()->getlocale())->title}}">
    </div>
</section>
@else
